...
public class Rotasi_SuccessionCP_Adapter extends BaseAdapter {
  ...
  public Rotasi_SuccessionCP_Adapter(Context mContext, List<RotasiSCPModel> listModel) {
  ...
  public View getView(int position, View view, ViewGroup viewGroup) {
    ...
    if (view == null) {
      ...
      view = inflater.inflate(R.layout.item_list_rotasi_ecp__adapter, null);
    }

    String number = String.valueOf(model.getNumber());
    ...
    tvTittle.setText(model.getPosition_name());

    tvAplican = view.findViewById(R.id.isi_aplicans);
    tvAplican.setTypeface(font);
    tvAplican.setText(model.getPersonel_name());
...
//    tvBand.setTypeface(fontbold);
    ...
    tvRank.setText(model.getPersonel_number());
