 ...
 */
public class ECCanceledFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_eccanceled, container, false);
    ...
    private void getMyBooking(){
        ...
        AndroidNetworking.get(session.getServerURL()+"users/showallbooking/themeid/"+session.getThemeId()+"/bookstatus/C/buscd/"+session.getUserBusinessCode())
