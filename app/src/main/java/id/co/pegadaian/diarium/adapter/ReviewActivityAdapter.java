...
public class ReviewActivityAdapter extends RecyclerView.Adapter<ReviewActivityAdapter.MyViewHolder> {
  ...
  public ReviewActivityAdapter(List<ReviewCourseModel> listmodel) {
