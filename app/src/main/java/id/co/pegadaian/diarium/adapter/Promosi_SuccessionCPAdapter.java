...
public class Promosi_SuccessionCPAdapter extends BaseAdapter {
  ...
  public Promosi_SuccessionCPAdapter(Context mContext, List<PromosiSCPModel> listModel) {
  ...
  public View getView(int position, View view, ViewGroup viewGroup) {
    ...
    tvTittle.setText(model.getNumber()+".  "+model.getPosition_name());
