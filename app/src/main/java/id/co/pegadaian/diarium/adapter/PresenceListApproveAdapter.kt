...
class PresenceListApproveAdapter : RecyclerView.Adapter<PresenceListApproveAdapter.UserViewHolder>() {

    private var onItemClickCallback : PresenceListApproveAdapter.OnItemClickCallback? = null
    private val mData = ArrayList<DataPresenceList>()
    private var mFilter = ArrayList<DataPresenceList>()

    fun setOnItemClickCallback(onItemClickCallback: PresenceListApproveAdapter.OnItemClickCallback){
    ...
    inner class UserViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView){
        ...
        fun bind(data: DataPresenceList){
            with(itemView){
                ...
                var statusApproval = data.statusName
