...
public class TesAdapter extends BaseAdapter {
    ...
    private List<TesModel> listModel;
    ...
    public TesAdapter(Context mContext, List<TesModel> listModel) {
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        tvScheduleName.setText(model.getTemplate_name());
        tvTopic.setText(model.getType());
