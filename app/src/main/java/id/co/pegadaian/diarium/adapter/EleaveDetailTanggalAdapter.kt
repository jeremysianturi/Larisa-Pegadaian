...
class EleaveDetailTanggalAdapter : RecyclerView.Adapter<EleaveDetailTanggalAdapter.UserViewHolder>(){

    private var onItemClickCallback : EleaveDetailTanggalAdapter.OnItemClickCallback? = null
    private val mData = ArrayList<DataEleaveDetailTanggal>()
    private var mFilter = ArrayList<DataEleaveDetailTanggal>()

    fun setOnItemClickCallback(onItemClickCallback: EleaveDetailTanggalAdapter.OnItemClickCallback){
        this.onItemClickCallback = onItemClickCallback
    }

    fun setData(items: ArrayList<DataEleaveDetailTanggal>){
    ...
    inner class UserViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView){
        ...
        fun bind(data: DataEleaveDetailTanggal){
            with(itemView){
    ...
    interface OnItemClickCallback {
        fun onItemClicked(data: DataEleaveDetailTanggal)
    }
}