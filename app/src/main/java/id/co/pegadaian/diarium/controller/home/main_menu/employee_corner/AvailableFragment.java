...
public class AvailableFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getMyBooking();
//        Toast.makeText(getActivity(), session.getThemeId(), Toast.LENGTH_SHORT).show();
        return view;
    ...
    private void getMyBooking(){
        ...
        AndroidNetworking.get(session.getServerURL()+"users/showallbooking/themeid/"+session.getThemeId()+"/bookstatus/B/buscd/"+session.getUserBusinessCode())
