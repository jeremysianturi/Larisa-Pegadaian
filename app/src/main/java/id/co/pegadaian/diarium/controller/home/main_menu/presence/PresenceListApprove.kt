...
class PresenceListApprove : AppCompatActivity(),View.OnClickListener{

    private val tags = PresenceListApprove::class.java.simpleName
...
//    private lateinit var progressDialogHelper : ProgressDialogHelper
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_presence_list_approve)
...
//    }
    ...
    private fun approvePresenceConfirmation( objIdentifier: String?){
        ...
        Log.d(tags,"check body approve presence confirmation : $body")

        val urlApprovePresenceConf = "${baseUrl}users/presensi/absent"
        Log.d(tags,"check url approve presence confirmation di list approval : $urlApprovePresenceConf")
                ...
                .getAsJSONObject(object : JSONObjectRequestListener {
                    override fun onResponse(response: JSONObject?) {
                        ...
                        if (response?.getInt("status") == 200) {
                            resetAllFilter()
                            Toast.makeText(this@PresenceListApprove, responseMessage, Toast.LENGTH_SHORT).show()
                        } else {
                            Toast.makeText(this@PresenceListApprove, responseMessage, Toast.LENGTH_SHORT).show()
                        }
                    ...
                    override fun onError(anError: ANError?) {
                        ...
                        Toast.makeText(this@PresenceListApprove, onErrornya, Toast.LENGTH_SHORT).show()
                    }
                })
    ...
    private fun rejectPresenceConfirmation (objectIdentifier : String?) {
        ...
        val requestUrl = "${baseUrl}users/presensi/absent"
        Log.d(tags,"api reject presence confirmation : $requestUrl")
                ...
                .getAsJSONObject(object : JSONObjectRequestListener {
                    ...
                    override fun onResponse(response: JSONObject?) {
                        ...
                        if (intResponse == 200){
                            ...
                            Toast.makeText(this@PresenceListApprove, "Rejected!", Toast.LENGTH_SHORT).show()
