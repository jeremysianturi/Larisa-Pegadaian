...
public class EventNonTematikAdapter extends ArrayAdapter<String> {
    ...
    public EventNonTematikAdapter(Activity context, String[] judul_event, String[] tanggal, String[] tempat) {
       ...
       lokasi.setTypeface(fontbold);
        ...
        menu.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                Intent hariian = new Intent(context , EventActivity.class);
